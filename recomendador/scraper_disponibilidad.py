...
def ejecutar_scraping_github():
    ...
    print(f"🚀 Iniciando extracción TOTAL (Modo GitHub Actions)...")
    ...
    if resultados:
        ...
        # IMPORTANTE: Guardamos el archivo sin usar files.download()
        df.to_excel("disponibilidad_catalogo_completo.xlsx", index=False)
        print(f"\n✨ ¡CONSEGUIDO! {len(df)} libros procesados.")

if __name__ == "__main__":
    ejecutar_scraping_github()
