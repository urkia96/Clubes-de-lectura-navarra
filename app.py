...
texts = {
    "Castellano": {
        ...
        "input_query": "Puedes escribir lo que quieras. Para términos exactos en Título, Autor, Resúmen o Palabras clave, usa comillas "". Para usar el booleano NOT, usa "-". Por ejemplo, "Novelas sobre la historia de navarra -"Carlos III"",
    ...
    "Euskera": {
        ...
        "input_query": ""Nahi duzuna idatz dezakezu. Izenburu, Autore, Laburpen edo Gako-hitzetako termino zehatzetarako, erabili komatxoak "". NOT boolearra erabiltzeko, erabili "-". Adibidez, "Navrra-ren historiari buruzko eleberriak -"Karlos III.a"",
