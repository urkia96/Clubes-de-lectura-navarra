...
@st.cache_resource
def load_resources():
    excel_path = os.path.join(PATH_RECO, "Etiquetas_Normalizadas_Final (1) (2).xlsx")
    ...
    # 4. CARGA IA
    with open(os.path.join(PATH_RECO, "clubes_lectura_small_modelo1_keywords (1).pkl"), "rb") as f:
    ...
    index = faiss.read_index(os.path.join(PATH_RECO, "clubes_lectura_small_modelo1_keywords (1).index"))
