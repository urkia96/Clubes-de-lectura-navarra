...
def load_resources():
    ...
    # 4. CARGA IA
    with open(os.path.join(PATH_RECO, "clubes_lectura_small_modelo1_keywords (1) (1) (1) (1) (1).pkl"), "rb") as f:
    ...
    index = faiss.read_index(os.path.join(PATH_RECO, "clubes_lectura_small_modelo1_keywords (1) (1) (1) (1) (1).index"))
