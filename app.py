...
texts = {
    "Castellano": {
        ...
        "f_actualizacion": "Última actualización: 26/05/2026",
        ...
        "input_query": "Puedes escribir lo que quieras. Usa **\" \"** para frases exactas (ej: *\"edad media\"*) y **-** para excluir palabras (ej: *romance -juvenil*). ",
    ...
    "Euskera": {
        ...
        "f_actualizacion": "Azken eguneratzea: 2026/05/26",
        ...
        "input_query": "Edozein gauza idatzi dezakezu. Erabili **\" \"** esaldi zehatzetarako (adib: *\"erdi aroa\"*) eta **-** hitzak baztertzeko (adib: *erromantzea -gaztea*).",
...
@st.cache_resource
def load_resources():
    excel_path = os.path.join(PATH_RECO, "Etiquetas_Normalizadas_Final (1) (2) (1) (1) (2).xlsx")
    disp_path = os.path.join(PATH_RECO, "disponibilidad_catalogo_completo (6).xlsx")
    ...
    # 4. CARGA IA
    with open(os.path.join(PATH_RECO, "clubes_lectura_small_modelo1_keywords (1) (1) (1) (1) (2).pkl"), "rb") as f:
    ...
    index = faiss.read_index(os.path.join(PATH_RECO, "clubes_lectura_small_modelo1_keywords (1) (1) (1) (1) (2).index"))
